...
export default function BadgeChangingKanban() {
  ...
  const [openInputColumnId, setOpenInputColumnId] = useState<string | null>(
    null
  );
  ...
  const handleTaskDragStart = (
    ...
    e.dataTransfer.setData("taskData", JSON.stringify({ taskId, columnId }));
  };
  ...
  const handleColumnDragStart = (
    ...
    e.dataTransfer.setData("columnData", column.id);
  };
  ...
  const handleTaskDrop = (
    ...
    e.preventDefault();
    const { taskId, columnId } = JSON.parse(e.dataTransfer.getData("taskData"));
  ...
  const handleColumnDrop = (
    ...
    e.preventDefault();
    const draggedColumnId = e.dataTransfer.getData("columnData");
        ...
        {columns.map((column) => (
          ...
          >
            <div className="mb-4 flex items-center justify-between">
              ...
              <button
                onClick={() =>
                  setOpenInputColumnId(
                    openInputColumnId === column.id ? null : column.id
                  )
                }
            ...
            <div className="flex flex-col gap-3">
              {column.tasks.map((task) => (
                <div
                  ...
                  draggable
                  onDragStart={(e) =>
                    handleTaskDragStart(e, task.id, column.id)
                  }
                  onDragOver={handleDragOver}
